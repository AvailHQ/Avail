...
Based on investor feedback — June 2026

---

## Hero

- [x] Replace subtitle — old: "Avail gives coaches physiological context before training decisions are made, Not after" → new two-line subtitle: "Predictive physiological modelling, individual to each athlete. / A Load Score for every athlete, before every session."
...
- [x] Activate WhoItsForSection on homepage (was not rendered)
- [x] Move WhoItsForSection to directly below Hero
- [x] Set default active tab to Coach (was Athletes)
