  ...
  return (
    ...
    >
      <div className="relative flex min-h-screen items-center overflow-visible px-6 py-24 hero:sticky hero:top-0 hero:overflow-hidden">
        ...
        <div className="workflow-narrative-grid relative mx-auto grid w-full max-w-[1120px] gap-10 hero:grid-cols-[0.48fr_0.52fr] hero:items-start wide:max-w-[1560px] wide:grid-cols-[minmax(0,620px)_704px] wide:gap-[136px]">
          <div>
