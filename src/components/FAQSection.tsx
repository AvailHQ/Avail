...
const FAQS = [
  ...
  {
    q: "Does Avail support wearable integrations?",
    a: [
      "Avail is designed to integrate with existing performance workflows, including wearable devices, GPS tracking systems, and training-management platforms when available.",
      "But right now, Avail does not depend on wearables, allowing teams to adopt the system without requiring additional hardware infrastructure.",
    ],
  },
  {
    ...
    >
      <div className="max-w-[720px] mx-auto wide:max-w-[980px]">
        ...
        <div
          ...
          style={{
            boxShadow:
              "0 1px 12px rgba(0,0,0,0.055), 0 0 0 1px rgba(0,0,0,0.04)",
          }}
        >
          <div className="px-8">
            {FAQS.map((item, i) => (
